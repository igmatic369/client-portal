-- Set the editor schema for LD Nails & Spa
-- Run this in the Supabase SQL Editor (Dashboard → SQL Editor → New query)
-- After running, verify with: SELECT slug, schema FROM sites WHERE slug = 'ld-nails-and-spa';
    ...
    },
    {
      ...
      "fields": [
        ...
        { "key": "follow_body",    "label": "Follow Body",      "type": "text",     "maxLength": 150 },
        {
          ...
          "item_label": "Image",
          "item_fields": [
            { "key": "src", "label": "Image (filename or URL)", "type": "text", "maxLength": 300 },
            { "key": "alt", "label": "Alt Text",                "type": "text", "maxLength": 120 }
          ]
        }
      ]
    },
